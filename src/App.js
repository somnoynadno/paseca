...
import PreferencesPage from "./pages/lk/user/PreferencesPage";
...
import SubscriptionsPage from "./pages/lk/subscriptions/SubscriptionsPage";
import HelpPage from "./pages/lk/user/HelpPage";
...
import SubscriptionNotSufficientPage from "./pages/lk/subscriptions/SubscriptionNotSufficientPage";
import SubscriptionExpiredPage from "./pages/lk/subscriptions/SubscriptionExpiredPage";
    ...
    return (
        <div className="App">
            <Switch>
                ...
                <Route history={history} exact path='/subscription_expired' component={SubscriptionExpiredPage} />
                <Route history={history} exact path='/subscription_not_sufficient' component={SubscriptionNotSufficientPage} />
